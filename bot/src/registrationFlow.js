 ...
 *
 * فرم شماره‌ی تایپ‌شده را به هر حال رد می‌کند؛ این متن فقط باعث می‌شود
 * کاربر پیش از تایپ کردن بفهمد، نه بعد از آن.
 *
 * سقفش ۶۴ کاراکتر است و متنِ بلندتر کلِ پیام را از سمتِ تلگرام رد
 * می‌کند، نه اینکه بریده شود.
 */
const PHONE_PLACEHOLDER = "تایپ نکنید - دکمه‌ی «ارسال شماره موبایل» را بزنید 👇";
