...
const BUILD = "econ+outbox+miniapp+faq+public+kb-52-sprite+crm-d1-58";
...
export default {
  ...
  async scheduled(event, env, ctx) {
    ...
    // خلاصه‌ی ۷:۳۰ صبح تهران. کران کلادفلر همیشه UTC است، پس ۴:۰۰ UTC
    // دقیقاً ۷:۳۰ تهران است - و چون ایران تغییر ساعت تابستانی ندارد،
    ...
    if (cron === ALERT_CRON) {
      ...
      // نمی‌شود؛ اجرای ۷:۳۰ تکه‌ی اول را می‌فرستد و این بقیه را.
