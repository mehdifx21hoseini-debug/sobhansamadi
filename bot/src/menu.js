...
export const MENU_LABELS = {
  ...
  SUPPORT: "💬 پشتیبانی",
  // تلگرام برای رنگ دکمه فقط primary/success/danger می‌دهد و بنفش ندارد،
  // پس تمایز این دکمه با ایموجی ساخته شده نه با رنگ.
  ABOUT: "💜 درباره آکادمی",
};
...
const LEGACY_LABELS = {
  ...
  // برچسب قبلیِ «درباره آکادمی» با ایموجی 🏛. کیبورد تلگرام سمت کاربر کش
  // می‌شود، پس کسی که تازه /start نزده هنوز همین را می‌فرستد و بدون این
