		(function () {
			...
			// یکی شکلِ روز را.
			//
			// هندسه اندازه‌گیری شده است، نه سلیقه‌ای. بیرون: خط‌چه‌های خبر
			// تا r0-14 پایین می‌آیند، پس بیرونی‌ترین کمان با ضخامتِ ۷ نباید
			// از آن رد شود - r0-22 با نیم‌ضخامتِ ۳٫۵ روی ۹۹٫۵ می‌ایستد.
			// داخل: با گامِ ۱۰، درونی‌ترین حلقه روی ۵۶ می‌نشیند و مرکز
			// بیش از بیست پیکسل آزاد دارد. سنجه‌ی جداگانه‌ای همین را در
			// پنج عرض می‌سنجد، تا اگر روزی چیزی به مرکز برگشت بی‌صدا
			// روی حلقه‌ها نیفتد.
			// ═══════════════════════════════════════════════════════════
			...
			function renderMarkets(container) {
				...
				// وسطِ دیال عمداً خالی است.
				//
				// رقمِ ساعت اینجا بود و برداشته شد: ساعتِ بنر بالای همین
				// صفحه همان عدد را - با همان منطقه - نشان می‌دهد، و دو
				// ساعتِ یکسان در یک نما فقط جا می‌گرفت. چیزی که می‌ماند
				// حرفی است که هیچ‌جای دیگر گفته نمی‌شود: بازار باز است یا
				// نه. خودِ کمان‌ها و عقربه ساعت را می‌گویند.
